...
void CAboutDlg::OnBnClickedCheckReadbook()
{
	...
	{
		ShellExecute(NULL,"open",g_strCurDir + "\\WLR-711E 扫描式激光传感器说明书V1.0.pdf",NULL,NULL,SW_SHOWNORMAL);
	}
	// TODO: 在此添加控件通知处理程序代码
}
...
void CAboutDlg::OnBnClickedCheckReadbook2()
{
	...
	{
		ShellExecute(NULL,"open",g_strCurDir + "\\WLR-711E 扫描式激光传感器上位机软件生产版说明书V1.0.pdf",NULL,NULL,SW_SHOWNORMAL);
	}
}
