...
LaserDoc.h，LaserDoc.cpp - 文档
这些文件包含 CLaserDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CLaserDoc::Serialize)。
文档将具有下列字符串:
文件扩展名:      Laser
文件类型 ID:        Laser.Document
主框架标题:  Laser
文档类型名称:       Laser
筛选器名:         Laser Files (*.Laser)
文件的新简称: Laser
文件类型全名: Laser.Document

LaserView.h，LaserView.cpp - 文档的视图
这些文件包含 CLaserView 类。
CLaserView 对象用于查看 CLaserDoc 对象。
